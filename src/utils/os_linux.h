...
typedef enum : intptr {
  ...
  ERANGE = intptr(-34),
  EDEADLOCK = intptr(-35),
  ENAMETOOLONG = intptr(-36),
  ENOLCK = intptr(-37),
  ENOSYS = intptr(-38),
  ENOTEMPTY = intptr(-39),
  ELOOP = intptr(-40),
  EUNKNOWN_41 = intptr(-41),
  ENOMSG = intptr(-42),
  EIDRM = intptr(-43),
  ECHRNG = intptr(-44),
  EL2NSYNC = intptr(-45),
  ...
  EUSERS = intptr(-87),
  ENOTSOCK = intptr(-88),
  EDESTADDRREQ = intptr(-89),
  EMSGSIZE = intptr(-90),
  EPROTOTYPE = intptr(-91),
  ENOPROTOOPT = intptr(-92),
  EPROTONOSUPPORT = intptr(-93),
  ESOCKTNOSUPPORT = intptr(-94),
  EOPNOTSUPP = intptr(-95),
  EPFNOSUPPORT = intptr(-96),
  EAFNOSUPPORT = intptr(-97),
  EADDRINUSE = intptr(-98),
  EADDRNOTAVAIL = intptr(-99),
  ENETDOWN = intptr(-100),
  ENETUNREACH = intptr(-101),
  ENETRESET = intptr(-102),
  ECONNABORTED = intptr(-103),
  ECONNRESET = intptr(-104),
  ENOBUFS = intptr(-105),
  EISCONN = intptr(-106),
  ENOTCONN = intptr(-107),
  ESHUTDOWN = intptr(-108),
  ETOOMANYREFS = intptr(-109),
  ETIMEDOUT = intptr(-110),
  ECONNREFUSED = intptr(-111),
  EHOSTDOWN = intptr(-112),
  EHOSTUNREACH = intptr(-113),
  EALREADY = intptr(-114),
  EINPROGRESS = intptr(-115),
  ESTALE = intptr(-116),
  EUCLEAN = intptr(-117),
  ENOTNAM = intptr(-118),
  ENAVAIL = intptr(-119),
  EISNAM = intptr(-120),
  EREMOTEIO = intptr(-121),
  EDQUOT = intptr(-122),
  ENOMEDIUM = intptr(-123),
  EMEDIUMTYPE = intptr(-124),
  ECANCELED = intptr(-125),
  ENOKEY = intptr(-126),
  EKEYEXPIRED = intptr(-127),
  EKEYREVOKED = intptr(-128),
  EKEYREJECTED = intptr(-129),
  EOWNERDEAD = intptr(-130),
  ENOTRECOVERABLE = intptr(-131),
  ERFKILL = intptr(-132),
